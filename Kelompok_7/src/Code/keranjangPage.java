 ...
 * @author Asus
 */
public class keranjangPage extends javax.swing.JFrame {
    String id;
    /**
    ...
    public keranjangPage() {
        initComponents();
        display();
        Totalharga.setText(Integer.toString(getTotal()));
    }
    ...
    public int getTotal(){
        int rowsCount = keranjang.getRowCount();
        int sum = 0;
        for(int i = 0; i<rowsCount; i++){
            sum = sum+Integer.parseInt(keranjang.getValueAt(i, 4).toString());
        }
        return sum;
    }
    ...
    public String getNama(){
        ...
        String sum = "";
        for(int i = 0; i<rowsCount;i++){
            sum = sum+keranjang.getValueAt(i, 1);
        }
        return sum;
    }
    /**
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/carts.png"))); // NOI18N
        ...
        keranjang.setBackground(new java.awt.Color(245, 245, 245));
        keranjang.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null, null}
            },
            new String [] {
                "Kode", "Nama", "Harga", "Banyak", "Total"
            }
        ) {
        ...
        Totalharga.setAlignmentX(0.0F);
        Totalharga.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, java.awt.Color.pink, java.awt.Color.pink, java.awt.Color.pink, java.awt.Color.pink));
    ...
    private void keranjangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_keranjangMouseClicked
        ...
        id = (String)keranjang.getValueAt(row, 0);
    }//GEN-LAST:event_keranjangMouseClicked

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        try{
            String sql = "DELETE FROM keranjang WHERE Kode_Barang = ?";
            java.sql.Connection conn = Connect.configDB();
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
            pst.setString(1, id);
            pst.executeUpdate();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(keranjang.getRowCount() == 0){
            ...
            try{
                Akun akun = new Akun();
                String sql = "INSERT INTO pesanan(Username, NamaBarang, Harga, Status) VALUES ('"+akun.Username+"','"+getNama()+"','"+getTotal()+"','Dalam Proses')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(keranjangPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
